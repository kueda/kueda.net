...
My most monetizable skill is being able to write code, mostly Ruby, Javascript and its ilk, some Python, even less Rust. I'm best on the frontend, but I've worked at most levels of the web stack. I spent quite a bit of the end of my time at iNat working on internationalization and translation management and integration. I'm also a decent writer, perhaps a reasonable editor, an enthusiastic skeptic, and have moderate familiarity with biology, California natural history, and biodiversity informatics if we still call it that.
